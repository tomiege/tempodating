...
interface OnlineSpeedDatingGayEvent {
  productId: number
  gmtdatetime: string
  title: string
  country: string
...
export default function OnlineSpeedDatingGayPage() {
  const [events, setEvents] = useState<OnlineSpeedDatingGayEvent[]>([])
  ...
  const eventsByCountry = filteredEvents.reduce((acc, event) => {
    ...
    return acc
  }, {} as Record<string, OnlineSpeedDatingGayEvent[]>)
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <p className="text-sm font-medium text-primary uppercase tracking-wider mb-4">
              Online Speed Dating for Gay Men
            </p>
            <h1 className="font-serif text-3xl md:text-4xl font-semibold text-foreground mb-6 text-balance max-w-2xl mx-auto">
              Meet Like-Minded Gay Men from Anywhere
            </h1>
            <p className="text-muted-foreground max-w-2xl mx-auto text-pretty mb-8">
              Join our virtual speed dating events designed exclusively for gay men.
              Connect with singles from your area in a welcoming, inclusive environment — all from the comfort of your home.
            </p>
                    ...
                    {countryEvents.map((event) => (
                      ...
                      >
                        <CardContent className="p-6">
                          ...
                          <h3 className="font-semibold text-lg text-foreground mb-2">Speed Dating for Gay Men</h3>
