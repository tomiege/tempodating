...
function ProductContent() {
  ...
  const galleryImages = [
    "/onlineSpeedDatingGay/gallery/1.jpg",
    "/onlineSpeedDatingGay/gallery/2.jpg",
    "/onlineSpeedDatingGay/gallery/3.jpg",
    "/onlineSpeedDatingGay/gallery/4.jpg"
  ]
  ...
  useEffect(() => {
    async function fetchProduct() {
      ...
      try {
        const response = await fetch('/api/products/onlineSpeedDatingGay')
        ...
        Sentry.captureException(err, {
          tags: { source: 'product-page-gay', productId: productId ?? undefined, productType: productType ?? undefined },
        })
      ...
      <section className="pt-24 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative rounded-2xl overflow-hidden mb-8 aspect-video">
            <Image
              src="/onlineSpeedDatingGay/banner.jpg"
              alt="Gay Speed Dating"
              fill
          ...
          <div className="mb-6 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-3">
              Gay Speed Dating | <span className="text-primary">{city}</span>
            </h1>
          </div>
          ...
          {/* Promotional Section */}
          <Card className="mb-8 max-w-3xl mx-auto bg-gradient-to-br from-blue-50 to-purple-50 border-primary/20">
            <CardContent className="p-6 sm:p-8">
              <div className="grid md:grid-cols-2 gap-6 items-center">
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 flex items-start gap-2">
                    <span className="text-3xl">🏳️‍🌈</span>
                    <span>Gay Speed Dating in {city}</span>
                  </h2>
                  <p className="text-lg font-semibold text-primary mb-4">
                    Meet Like-Minded Men Near You
                  </p>
                  <p className="text-muted-foreground mb-3">
                    Connect with gay men in {city}. 60 minutes, 8 meaningful conversations. <span className="text-primary font-semibold">A safe, welcoming space to find your match!</span>
                  </p>
                  <p className="text-muted-foreground mb-4">
                    Register, take a quick quiz, and get matched with compatible singles.
                  </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Meet 8 hand-picked gay men from {city} in fun 4-minute chats. Our AI matching + icebreaker questions = no awkward silences!
                      </p>
                    </div>
...
export default function OnlineSpeedDatingGayProductPage() {
  return (
    <Suspense fallback={
      <main className="min-h-screen">
        <Header />
