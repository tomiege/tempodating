...
function ProductContent() {
  ...
  const galleryImages = [
    "/onlineSpeedDatingJewish/gallery/1.jpg",
    "/onlineSpeedDatingJewish/gallery/2.jpg",
    "/onlineSpeedDatingJewish/gallery/3.jpg",
    "/onlineSpeedDatingJewish/gallery/4.jpg"
  ]
    ...
    async function fetchProduct() {
      ...
      try {
        ...
        const foundProduct = allEvents.find(
          (p: OnlineSpeedDatingEvent) => p.productId === parseInt(productId) && p.productType === 'onlineSpeedDatingJewish'
        )
        ...
        Sentry.captureException(err, {
          tags: { source: 'product-page-jewish', productId: productId ?? undefined, productType: productType ?? undefined },
        })
    ...
    <main className="min-h-screen">
      ...
      <section className="pt-24 pb-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative rounded-2xl overflow-hidden mb-8 aspect-video">
            <Image
              src="/onlineSpeedDatingJewish/banner.jpg"
              alt="Jewish Speed Dating"
              fill
          ...
          <div className="mb-6 text-center">
            <h1 className="text-4xl sm:text-5xl font-bold text-foreground mb-3">
              Jewish Speed Dating | <span className="text-primary">{city}</span>
            </h1>
          </div>
          ...
          {/* Promotional Section */}
          <Card className="mb-8 max-w-3xl mx-auto bg-gradient-to-br from-blue-50 to-indigo-50 border-primary/20">
            <CardContent className="p-6 sm:p-8">
              <div className="grid md:grid-cols-2 gap-6 items-center">
                <div>
                  <h2 className="text-2xl sm:text-3xl font-bold text-foreground mb-3 flex items-start gap-2">
                    <span className="text-3xl">✡️</span>
                    <span>Jewish Speed Dating in {city}</span>
                  </h2>
                  <p className="text-lg font-semibold text-primary mb-4">
                    Meet Jewish Singles Near You
                  </p>
                  <p className="text-muted-foreground mb-3">
                    Connect with Jewish singles in {city}. 60 minutes, 8 meaningful conversations. <span className="text-primary font-semibold">Find someone who shares your values and traditions!</span>
                  </p>
                  <p className="text-muted-foreground mb-4">
                    Register, take a quick quiz, and get matched with compatible Jewish singles.
                  </p>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Meet 8 hand-picked Jewish singles from {city} in fun 4-minute chats. Our AI matching + icebreaker questions = no awkward silences!
                      </p>
                    </div>
      ...
      {product && (
        <TicketModal 
          ...
          eventTitle="Jewish Speed Dating"
...
export default function OnlineSpeedDatingJewishProductPage() {
  return (
    <Suspense fallback={
      <main className="min-h-screen">
        <Header />
